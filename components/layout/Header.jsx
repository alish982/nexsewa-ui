  ...
  return (
    <>
      <header className="sticky top-0 z-50 bg-white shadow-md">
        <div className="max-w-7xl mx-auto px-4 md:px-6 py-4">
          <div className="flex items-center justify-between gap-4">
            <Image
              ...
              width={127}
              height={127}
              className="w-20 h-auto sm:w-[127px]"
            />
            ...
            <div className="flex items-center gap-2">
              <button className="relative p-2 hover:bg-gray-100 rounded-lg transition-colors">
                <ShoppingCart className="w-6 h-6 text-gray-400 fill-current" />
                {cartCount > 0 && (
        ...
        {mobileMenuOpen && (
          <div className="absolute top-14 right-12 md:hidden border border-gray-200 py-4 px-4 bg-white">
      ...
      <div className="flex items-center h-[53px] gap-2 px-4 xl:pl-[85px] 2xl:pl-[340px] bg-[#F4F5F6]">
